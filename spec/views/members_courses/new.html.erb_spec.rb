...
describe "members_courses/new" do
  before(:each) do
    assign(:members_course, stub_model(MembersCourse,
      :member_id => 1,
      :course_id => 1,
      :note => "MyText",
      :introduction => false
  ...
  it "renders new members_course form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form[action=?][method=?]", members_courses_path, "post" do
