...
describe TimeSlotsController do
  ...
  let(:valid_attributes) { { "start_time" => "2013-08-22 08:37:50" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved time_slot as @time_slot" do
        ...
        post :create, {:time_slot => { "start_time" => "invalid value" }}, valid_session
        assigns(:time_slot).should be_a_new(TimeSlot)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested time_slot" do
        ...
        TimeSlot.any_instance.should_receive(:update).with({ "start_time" => "2013-08-22 08:37:50" })
        put :update, {:id => time_slot.to_param, :time_slot => { "start_time" => "2013-08-22 08:37:50" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the time_slot as @time_slot" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        TimeSlot.any_instance.stub(:save).and_return(false)
        put :update, {:id => time_slot.to_param, :time_slot => { "start_time" => "invalid value" }}, valid_session
        assigns(:time_slot).should eq(time_slot)
      end
