...
describe BankAccountsController do
  ...
  let(:valid_attributes) { { "holder_name" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bank_account as @bank_account" do
        ...
        post :create, {:bank_account => { "holder_name" => "invalid value" }}, valid_session
        assigns(:bank_account).should be_a_new(BankAccount)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bank_account" do
        ...
        BankAccount.any_instance.should_receive(:update).with({ "holder_name" => "MyString" })
        put :update, {:id => bank_account.to_param, :bank_account => { "holder_name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bank_account as @bank_account" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        BankAccount.any_instance.stub(:save).and_return(false)
        put :update, {:id => bank_account.to_param, :bank_account => { "holder_name" => "invalid value" }}, valid_session
        assigns(:bank_account).should eq(bank_account)
      end
