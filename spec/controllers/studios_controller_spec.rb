  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved studio as @studio" do
        ...
        post :create, {:studio => { "name" => "invalid value" }}, valid_session
        assigns(:studio).should be_a_new(Studio)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested studio" do
        ...
        Studio.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => studio.to_param, :studio => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the studio as @studio" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Studio.any_instance.stub(:save).and_return(false)
        put :update, {:id => studio.to_param, :studio => { "name" => "invalid value" }}, valid_session
        assigns(:studio).should eq(studio)
      end
