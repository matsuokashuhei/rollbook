...
describe DebitsController do
  ...
  let(:valid_attributes) { { "bank_account_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved debit as @debit" do
        ...
        post :create, {:debit => { "bank_account_id" => "invalid value" }}, valid_session
        assigns(:debit).should be_a_new(Debit)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested debit" do
        ...
        Debit.any_instance.should_receive(:update).with({ "bank_account_id" => "1" })
        put :update, {:id => debit.to_param, :debit => { "bank_account_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the debit as @debit" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Debit.any_instance.stub(:save).and_return(false)
        put :update, {:id => debit.to_param, :debit => { "bank_account_id" => "invalid value" }}, valid_session
        assigns(:debit).should eq(debit)
      end
